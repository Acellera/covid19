...
#for reference
fragalysis = Molecule('noncovhits/Mpro-x0104.pdb')


sims = simlist(glob('filtered/*/'), glob('filtered/filtered.pdb'))
metr = Metric(sims)
...
model.markovModel(5, 2, units='ns')
...
frag_alig.view(sel='resname MOL', style='Licorice')
